...
% Question #1:
% there will be three windows instead of two. The first one would have the top
% two plots of the original first window. The second window doesn't change. The
% third window contains the bottom two plots of the original first window
